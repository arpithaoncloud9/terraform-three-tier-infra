...
# =========================================================
# IRSA - IAM Role for Service Account (CloudWatch access)
# =========================================================
...
resource "aws_iam_role" "app_irsa" {
  ...
  assume_role_policy = jsonencode({
    ...
    Statement = [{
      ...
      Condition = {
        StringEquals = {
          "${replace(aws_iam_openid_connect_provider.eks.url, "https://", "")}:sub" = "system:serviceaccount:aws-3tier-dev:app-service-account"
